...
- 🎙️ Voice command input (Mic Logger)
- 📈 Expense breakdown, transactions, heatmaps
...
- SQLite / PostgreSQL (as configured)
...
```bash
git clone https://github.com/your-username/Crown Finance.git
cd Crown Finance
