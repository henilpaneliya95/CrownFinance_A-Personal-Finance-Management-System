                    ...
                    <CardContent className="relative space-y-4 p-4 pt-0 sm:p-5 sm:pt-0">
                      <div className="rounded-xl border border-teal-200/70 dark:border-teal-900/70 bg-white/90 dark:bg-slate-950/70 p-1.5 sm:p-2.5 shadow-sm">
                        <Calendar
                          ...
                          modifiersClassNames={{
                            hasTransaction:
                              "bg-emerald-600 text-white font-semibold rounded-md ring-2 ring-emerald-200 dark:ring-emerald-900",
                          }}
                          ...
                          classNames={{
                            ...
                            nav: "space-x-1 flex items-center",
                            nav_button:
                              "h-7 w-7 sm:h-8 sm:w-8 rounded-md bg-transparent p-0 text-slate-600 hover:text-slate-900 hover:bg-teal-100 dark:text-slate-300 dark:hover:text-white dark:hover:bg-slate-800",
                            nav_button_previous: "absolute left-1",
                            nav_button_next: "absolute right-1",
                            table: "w-full border-collapse",
                            head_row: "flex",
                            head_cell:
                              "w-7 sm:w-8 rounded-md text-center font-medium text-[0.7rem] sm:text-[0.8rem] text-slate-500 dark:text-slate-400",
                            row: "flex w-full mt-1.5 sm:mt-2",
                            cell: "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:rounded-md flex-1",
                            day: "inline-flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-md p-0 text-[11px] sm:text-[13px] font-medium text-slate-700 dark:text-slate-200 transition-colors hover:bg-teal-100 dark:hover:bg-slate-800 aria-selected:opacity-100",
                            day_selected:
                            ...
                            day_outside:
                              "text-slate-400 opacity-45 aria-selected:bg-teal-100/50 dark:aria-selected:bg-slate-800/50",
